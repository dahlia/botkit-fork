...
This policy is borrowed from [Fedify's AI usage policy][1], which is inspired by
[Ghostty's AI policy][2].

The BotKit project has the following rules for AI usage:
...
These rules apply only to outside contributions to BotKit.  Maintainers are
...
Please remember that BotKit is maintained by humans.
...
BotKit is written with plenty of AI assistance, and many maintainers embrace
